...
ace.define('ace/mode/contextmappingdsl_worker', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/worker/mirror', 'ace/mode/contextmappingdsl/contextmappingdslparse'], function(require, exports, module) {

	var oop = require("../lib/oop");
	var Mirror = require("../worker/mirror").Mirror;
	var contextmappingdslparse = require("../mode/contextmappingdsl/contextmappingdslparse");
	
	importScripts("../parser/antlr-all-min.js");
	importScripts("../parser/ContextMappingDSLLexer.js");
	importScripts("../parser/ContextMappingDSLParser.js");
	...
	(function() {
	    ...
	    this.onUpdate = function() {
		    ...
		    lexer = new ContextMappingDSLLexer(cstream);
		    tstream = new org.antlr.runtime.CommonTokenStream(lexer);
		    parser = new ContextMappingDSLParser(tstream);
		    try {
		    	parser.rule_ContextMappingModel();
		    } catch(err) {
...
ace.define('ace/mode/contextmappingdsl/contextmappingdslparse', ['require', 'exports', 'module' ], function(require, exports, module) {

(function (root, name, factory) {
   factory(exports)
}(this, 'contextmappingdslparse', function (exports) {
