 ...
 * @Generated
 */
ace.define('ace/theme/contextmappingdsl', ['require', 'exports', 'module' , 'ace/lib/dom'], function(require, exports, module) {

exports.isDark = false;
exports.cssText = ".ace-contextmappingdsl .ace_gutter {\
	background: #ebebeb;\
...
.ace-contextmappingdsl .ace_print-margin {\
	width: 1px;\
	background: #ebebeb;\
}\
.ace-contextmappingdsl {\
	background-color: #FFFFFF;\
}\
.ace-contextmappingdsl .ace_fold {\
	background-color: rgb(60, 76, 114);\
}\
.ace-contextmappingdsl .ace_cursor {\
	border-left: 2px solid black;\
}\
.ace-contextmappingdsl .ace_storage,\
.ace-contextmappingdsl .ace_keyword,\
.ace-contextmappingdsl .ace_variable {\
	font-weight: bold;\
	color: rgb(120, 0, 45);\
}\
.ace-contextmappingdsl .ace_constant.ace_buildin {\
	color: rgb(88, 72, 246);\
}\
.ace-contextmappingdsl .ace_constant.ace_library {\
	color: rgb(6, 150, 14);\
}\
.ace-contextmappingdsl .ace_function {\
	color: rgb(60, 76, 114);\
}\
.ace-contextmappingdsl .ace_string {\
	color: rgb(42, 0, 255);\
}\
.ace-contextmappingdsl .ace_comment {\
	color: rgb(113, 150, 130);\
}\
.ace-contextmappingdsl .ace_comment.ace_doc {\
	color: rgb(63, 95, 191);\
}\
.ace-contextmappingdsl .ace_comment.ace_doc.ace_tag {\
	color: rgb(127, 159, 191);\
}\
.ace-contextmappingdsl .ace_constant.ace_numeric {\
	color: darkblue;\
}\
.ace-contextmappingdsl .ace_tag {\
	color: rgb(25, 118, 116);\
}\
.ace-contextmappingdsl .ace_type {\
	color: rgb(127, 0, 127);\
}\
.ace-contextmappingdsl .ace_xml-pe {\
	color: rgb(104, 104, 91);\
}\
.ace-contextmappingdsl .ace_marker-layer .ace_selection {\
	background: rgb(181, 213, 255);\
}\
.ace-contextmappingdsl .ace_marker-layer .ace_bracket {\
	margin: -1px 0 0 -1px;\
	border: 1px solid rgb(192, 192, 192);\
}\
.ace-contextmappingdsl .ace_meta.ace_tag {\
	color:rgb(25, 118, 116);\
}\
.ace-contextmappingdsl .ace_invisible {\
	color: #ddd;\
}\
.ace-contextmappingdsl .ace_entity.ace_other.ace_attribute-name {\
	color:rgb(127, 0, 127);\
}\
.ace-contextmappingdsl .ace_marker-layer .ace_step {\
	background: rgb(255, 255, 0);\
}\
.ace-contextmappingdsl .ace_marker-layer .ace_active-line {\
	background: rgb(232, 242, 254);\
}\
.ace-contextmappingdsl .ace_marker-layer .ace_selected-word {\
	border: 1px solid rgb(181, 213, 255);\
}\
.ace-contextmappingdsl .ace_indent-guide {\
...
exports.cssClass = "ace-contextmappingdsl";
